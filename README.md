...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/package-subscription.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/package-subscription)
...
```php
$packageSubscription = new CleaniqueCoders\PackageSubscription();
echo $packageSubscription->echoPhrase('Hello, CleaniqueCoders!');
```
